...
const STAT_CARDS = [
  { key: 'total', label: 'Total demandes', icon: 'fa-shield-halved', gradient: 'from-teal-500 to-teal-700', shadow: 'shadow-teal-500/20' },
  { key: 'pending', label: 'En attente', icon: 'fa-hourglass-half', gradient: 'from-amber-500 to-orange-600', shadow: 'shadow-amber-500/20' },
  { key: 'approved', label: 'Validées', icon: 'fa-circle-check', gradient: 'from-emerald-500 to-green-700', shadow: 'shadow-emerald-500/20' },
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants} className="max-w-6xl mx-auto">
      ...
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        {pendingCount > 0 && (
          <Link href="/insurer/applications" className="inline-flex items-center gap-2 px-4 py-2 bg-amber-50 text-amber-700 rounded-xl text-sm font-bold border border-amber-200 hover:bg-amber-100 transition-all">
      ...
      <div className="grid lg:grid-cols-3 gap-6 mb-8">
        ...
        <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          <div className="space-y-3">
            <Link href="/insurer/applications" className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all group">
              <div className="w-10 h-10 bg-teal-100 text-teal-600 rounded-xl flex items-center justify-center group-hover:bg-teal-600 group-hover:text-white transition-all">
            ...
            <Link href="/contact" className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-teal-50 hover:text-teal-600 transition-all group">
              <div className="w-10 h-10 bg-teal-100 text-teal-600 rounded-xl flex items-center justify-center group-hover:bg-teal-600 group-hover:text-white transition-all">
        ...
        <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          {stats?.total > 0 ? (
            <div className="space-y-3">
              {[
                { label: 'En attente', count: stats?.pending || 0, color: 'bg-amber-500' },
      ...
      <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/insurer/applications" className="text-xs font-bold text-teal-600 hover:underline">
